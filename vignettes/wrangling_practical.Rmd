...
```{r, echo = FALSE, fig.align = 'center', eval = TRUE, fig.cap= "Source: https://www.rstudio.com/"}
knitr::include_graphics("images/dplyrhex.png")
```
...
3. Now save a copy of the data as `trialact`. This way if you do something wrong to the data, you can always get the original back.
...
17. Separately for male and female patients, calculate the percent who have a history of intraveneous drug use.
...
18. Separately for male and female patients (`gender`), calculate the percent who have a history of intraveneous drug use (`drugs`), and the percent of patients who indicate homosexual activity
