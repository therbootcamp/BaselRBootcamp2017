...
In this practical you'll conduct machine learning analyses. Here are the main functions and packages you'll be using:

| Algorithm| Function| Package | Additional Details |
|:------|:--------|:----|:----|
|     Regression|    `lm()`| Base R| https://bookdown.org/ndphillips/YaRrr/regression.html#the-linear-model|
|     Regularized regression|    `glmnet()`| `glmnet` |https://web.stanford.edu/~hastie/glmnet/glmnet_alpha.html |
|     Decision Trees|    `rpart()`| `rpart` | https://statweb.stanford.edu/~lpekelis/talks/13_datafest_cart_talk.pdf|
|     Fast and Frugal Decision Trees|   `FFTrees()`| `FFTrees` |https://cran.r-project.org/web/packages/FFTrees/vignettes/FFTrees_function.html |
