...
The following examples will take you through all steps of the machine learning process, from creating training and test data, to fitting models, to making predictions.
...
- For more advanced machine learning functionality, check out the `caret` package [Documentation Link](http://topepo.github.io/caret/index.html)
