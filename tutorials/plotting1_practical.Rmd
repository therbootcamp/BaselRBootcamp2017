...
corr_mtx <- cor(midwest %>% 
                  select(area, poptotal, popdensity, percwhite, percblack, 
                         percollege, percpovertyknown, inmetro, percadultpoverty))
...
Using the following template, create the following plot of savings data (`psavert`) from the `economics` dataset. 
...
Once you have done that, try creating the following plot from 
